...
if __name__ == "__main__":
    ...
    parser.add_argument('--date',   default="20240503")
    parser.add_argument('--start',  default="192000")
    parser.add_argument('--end',    default="203000")
    parser.add_argument('--iter',   default="9999999")
    parser.add_argument('--seat', default=SeatType.GENERAL_FIRST)
